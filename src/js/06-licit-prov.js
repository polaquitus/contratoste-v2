...
(function(){
  ...
  var ROLE_DEFAULTS={
    OWNER:{list:true,form:true,detail:true,me2n:true,idx:true,users:true,legales:true,rrll:true},
    ADMIN:{list:true,form:true,detail:true,me2n:true,idx:true,users:true,legales:true,rrll:true},
    ING_CONTRATOS:{list:true,form:true,detail:true,me2n:true,idx:false,users:false,legales:false,rrll:false},
    RESP_TECNICO:{list:true,form:false,detail:true,me2n:true,idx:false,users:false,legales:false,rrll:false},
  ...
  var UsersAdmin = window.UsersAdmin = (function(){
    ...
    function buildModal(){
      ...
      function hideAllViews(){ ['vList','vForm','vDet','vMe2n','vMe2nDet','vIdx','vUsersModule','vLegalesModule','vRrllModule'].forEach(function(id){ var el=q(id); if(el) el.classList.remove('on'); }); document.querySelectorAll('.sb-nav .nv').forEach(function(n){ n.classList.remove('act'); }); }
